...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5951589416:AAFv6-84yD9wUNnllvcReykiyYX2brWIE0A")
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001872719508")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "ksx_mdisk_bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "2027727486"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Rawatboyzz")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "https://t.me/ksX_Official")
#    GROUP_USERNAME = os.getenv("https://t.me/ksxgroup")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "https://t.me/ksX_Official")
